...
/*
Classe do animal Macaco
*/
public class Macaco extends Animal implements Primata{
    
    private static double atratividadeBase = 600; //Atratividade base do animal
    ...
    private static final int APETITEREPRODUTIVO = 55; //Apetite reprodutivo do animal
    
    public Macaco(String nome, boolean adiciona){ //Recebe dois argumentos "nome" é o nome artistico do animal e "adiciona" e se é ou não para adicionar o animal ao zoo
    ...
    public String toString() {
        return "Macaco (" +super.toString()+" AtratividadeBase: "+atratividadeBase+" Genoma:"+GENOMA+" EsperançaDeVida:"+ESPERANCAVIDA+" ApetiteReprodutivo:"+APETITEREPRODUTIVO+")";
    }
    ...
    */
    ...
    /*
    Método vindo da superclasse Animal para retirar ao saldo do zoo o custo da comida de um Macaco durante um ano
    */
    @Override
    ...
    /*
    Método vindo da superclasse Animal para retirar ao saldo do zoo o custo dos cuidadores de um Macaco durante um ano
    */
    @Override
